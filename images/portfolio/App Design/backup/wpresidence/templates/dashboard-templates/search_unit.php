...
?>
<div class="row property_wrapper_dash search_unit_wrapper">
    <h4> <?php the_title(); ?> </h4>
    <?php
    ...
    <a class="delete_search wpresidence_button " data-searchid="<?php print intval($post->ID); ?>"><?php esc_html_e('delete search','wpresidence');?></a>
