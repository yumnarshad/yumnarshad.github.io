...
<div class="col-md-3 user_menu_wrapper">
    <div class="dashboard_menu_user_image">
         <div class="menu_user_picture" style="background-image: url('<?php print esc_url($user_small_picture[0]); ?>');height: 60px;width: 60px;" ></div>
         <div class="dashboard_username">
             <?php esc_html_e('Welcome back, ','wpresidence'); echo esc_html($user_login).'!';?>
         </div>
     </div>
    <?php  get_template_part('templates/dashboard-templates/user_menu');  ?>
</div>
<?php get_template_part('templates/dashboard-templates/user_memebership_profile'); ?>
