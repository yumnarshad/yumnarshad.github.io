                ...
                if ( $custom_advanced_search == 'yes'){
                    ...
                    if(is_array($adv_search_what)){
                        ...
                        foreach($adv_search_what as $key=>$search_field){
                            wpestate_show_search_field($adv_search_label[$key],'mobile',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$select_county_state_list);
                        }
                    }
                }else{
