...
function wpestate_scripts() {
    ...
    $control_dependencies = array('jquery','anime.min','slick.min');
    if( wpresidence_get_option('wp_estate_use_optima','')!='yes'){
        $control_dependencies = array('jquery','anime.min','slick.min','bootstrap');
    ...
    if ( is_singular('estate_property') || is_page_template('user_dashboard_analytics.php')  || is_page_template('user_dashboard_main.php') || wpestate_is_property_modal() 
            ||   is_page_template('page_property_design.php') ){
   ...
   $measure_sys             = wpresidence_get_option('wp_estate_measure_sys','');
    ...
    if(is_singular('estate_property')  || is_singular('estate_agent')  || is_singular('estate_agency') || is_singular('estate_developer') || wpestate_is_property_modal() 
            || get_page_template_slug( get_the_ID())=='page_property_design.php'){
