...
function ocdi_import_files() {
  ...
  array(
      ...
      'local_import_file'              =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/pt-demo/theme_content.xml',
       'local_import_widget_file'      =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/pt-demo/widgets.wie',
       'local_import_redux'            =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/pt-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
    ...
    array(
      ...
      'local_import_file'            =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/fr-demo/theme_content.xml',
      'local_import_widget_file'     =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/fr-demo/widgets.wie',
      'local_import_redux'           =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/fr-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
  ...
  array(
      ...
      'local_import_file'            =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/esp-demo/theme_content.xml',
      'local_import_widget_file'     =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/esp-demo/widgets.wie',
      'local_import_redux'           =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/esp-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
   ...
   array(
      ...
      'local_import_file'            =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/de-demo/theme_content.xml',
      'local_import_widget_file'     =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/de-demo/widgets.wie',
      'local_import_redux'           =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/de-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
 ...
 array(
      ...
      'local_import_file'            =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/it-demo/theme_content.xml',
      'local_import_widget_file'     =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/it-demo/widgets.wie',
        'local_import_redux'         =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/it-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
     ...
     array(
      ...
      'local_import_file'            =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/rtl-demo/theme_content.xml',
      'local_import_widget_file'     =>  trailingslashit( get_template_directory() ) . 'wpestate_templates/rtl-demo/widgets.wie',
        'local_import_redux'         =>  array(
                array(
                  'file_path'   => trailingslashit( get_template_directory() ) . 'wpestate_templates/rtl-demo/redux_options.json',
                  'option_name' => 'wpresidence_admin',
                ),
        ),
